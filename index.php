            ...
            <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="txt_nombres" id="txt_nombres" class="form-control"
                        placeholder="Nombres: Jhensser Andree" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="txt_apellidos" id="txt_apellidos" class="form-control"
                        placeholder="Apellidos: Aguirre Galdámez" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="txt_direccion" id="txt_direccion" class="form-control"
                        placeholder="Direccion: 4ta calle 4-15" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="txt_telefono" id="txt_telefono" class="form-control"
                        placeholder="Telefono: 35410540" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
        ...
        <table class="table table-striped table-inverse table-responsive">
            ...
            <tbody>
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo ("<th>");
                    echo ("<a class=\"btn btn-primary\" id=\"btn_editar\" href=\"editar.php?id=". $fila['codigo'] ."\">Editar</a>");
